...
export class TrackComponent {
  ...
  galleryImages = [
      ...
      { src: 'assets/images/track/hound-playground.jpg', caption: 'Hound Playground'},
      { src: 'assets/images/track/playground.jpg', caption: 'Hound Playground'},
      { src: 'assets/images/track/playground2.jpg', caption: 'Hound Playground'},
      ...
      { src: 'assets/images/grounds/firebush.jpg', caption: 'Girebush'},
